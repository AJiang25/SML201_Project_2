...
matchups_16 = list(
        c(winners[1], winners[2]), c(winners[3], winners[4]),
        c(winners[5], winners[6]), c(winners[7], winners[8]),
        c(winners[9], winners[10]), c(winners[11], winners[12]),
        c(winners[13], winners[14]), c(winners[15], winners[16])
    )
...
winners_16 = run_round(winners_32, matchups_16)
